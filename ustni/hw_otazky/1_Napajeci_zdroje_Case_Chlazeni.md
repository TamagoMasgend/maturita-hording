...
- **ATX (Advanced Technology eXtended):** Naprostý standard pro stolní PC s rozměry 150 × 86 × 140 mm. Dlouhou dobu trhu dominoval standard **ATX 2.0 / 2.4** s důrazem na masivní 12V větev. Dnes je aktuální moderní specifikace **ATX 3.0 a ATX 3.1**, která vyžaduje schopnost zdroje absorbovat okamžité masivní výkonové špičky (Power Excursions) moderních grafických karet, které mohou na zlomek sekundy dosáhnout až dvojnásobku celkového udávaného výkonu zdroje.
...
- **24-pin ATX Main Power:** Masivní konektor napájející celou základní desku.
...
- **Molex (4-pin):** Starší, velmi masivní a dnes již ustupující konektor (dodává 12 V a 5 V). Používal se historicky pro staré PATA/IDE pevné disky, staré CD/DVD mechaniky, a často jako hrubá síla pro přídavné ventilátory nebo vodní pumpy.
...
Pokud zdroj v PC nechrání plně před výpadky celých bloků elektřiny (tzv. Blackouts), kolísáním frekvence či silnými bleskovými přepětími ze sítě, nastupuje UPS. Uvnitř obsahuje masivní olověné baterie, ze kterých střídač generuje vlastní napětí.
...
- **Formáty (Velikosti) a typy:** Dělí se primárně podle kompatibilní základní desky:
  ...
  - **HTPC (Home Theater PC) a SFF (Small Form Factor):** Úzké a velmi malé krabičky určené primárně do obýváku pod televizi k přehrávání médií nebo jako masivně úsporné kancelářské řešení na malý stůl.
  - **Rackové skříně:** Profesionální ploché obří servery zasouvané do 19" ocelových rozvaděčů v datacentrech (výška označovaná v "U" - např. 1U, 2U).
- **Casemodding:** Výrazná technická disciplína spojená se stavbou PC (PC Building), kdy si nadšenci svá PC upravují z estetického a funkčního hlediska. Řežou či ohýbají plechy, instalují masivní adresovatelné ARGB osvětlení řiditelné deskou, frézují vlastní komponenty, vytvářejí unikátní lakování a tvoří ze své skříně technologické umělecké dílo.
