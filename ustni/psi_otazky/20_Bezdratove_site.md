...
- **802.11ac (2014 - Wi-Fi 5)**: Průlom pouze na 5 GHz v masivních rychlostech nad **1,3 Gb/s** pro moderní multimedia. K řízení směrovosti začal být využíván *Beam forming*, kdy router sleduje pohybující se mobily v domě a matematicky formuje fázi záření antén čistě jejich směrem.
...
### Wireless PAN: Sítě Bluetooth a ZigBee
Sítě kategorie PAN pro extrémně malou, osobní plochu okolo člověka.
...
- **IrDA (Infrared Data Association)**: Mrtvý předchůdce Bluetooth snesený do infračerveného spektra optiky (vlnová délka 875 nm). Extrémně nespolehlivý, protože vysílací a přijímací diody musely mít striktní optickou přímou viditelnost (Line-of-Sight) na pár centimetrů bez jediné překážky a limitem pouhých 4 Mbps.
- **ZigBee (IEEE 802.15.4)**: Specifický průmyslový IoT standart operující v pásmech od 868 MHz po 2,4 GHz. Není určen pro rychlý přenos (limituje max. 250 kbit/s), ale zato vyniká enormní energetickou stabilitou, robustní **Mesh sítí** s automatickým směrováním (kde každá chytrá žárovka posílá data dalším žárovkám) a nulovou odezvou. Dominantně nasazován v automatizaci Smart Home budov nebo medicínských měřicích senzorech.

### Wireless MAN a WAN
Obří topologie postavené pro pokrytí celých měst nebo kontinentů poskytovateli Internetu.
